...
<AccordionGroup>
  ...
  <Tab title="iOS Setup (Beta)">

<Warning>
iOS support is currently in **beta**. Functionality is limited compared to Android.
</Warning>
...
- Learn about the [Agent System](/v4/concepts/agent-architecture)
