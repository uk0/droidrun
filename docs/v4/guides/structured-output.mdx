...
Extract typed, structured data from device automation tasks by passing a Pydantic model to `DroidAgent`. The agent collects data during execution and returns a validated Python object.
...
- [Custom Variables](/v4/guides/custom-variables)
