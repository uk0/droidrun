...
description: 'Extend Droidrun with custom Python functions and secure credential management'
---
...
See [Agent Architecture](/v4/concepts/agent-architecture) for understanding shared state and custom tools integration.
...
See [Custom Variables](/v4/guides/custom-variables) for non-sensitive data.
